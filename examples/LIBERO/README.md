> **Note** — this file is inherited from upstream StarVLA and documents *their* workflow and
> checkpoints. For THAW-VLA use the root `README.md` and `scripts/`. Kept here because the
> simulator installation steps below are still the correct ones.
